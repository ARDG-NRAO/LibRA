 ...
 */
     ...
     */
	CalDeviceRow* CalDeviceTable::newRow(Tag antennaId, Tag spectralWindowId, ArrayTimeInterval timeInterval, int feedId, int numCalload, std::vector<CalibrationDeviceMod::CalibrationDevice > calLoadNames){
 ...
 */
	...
	string CalDeviceTable::toXML()  {
		...
		buf.append("<CalDeviceTable xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:cldvc=\"http://Alma/XASDM/CalDeviceTable\" xsi:schemaLocation=\"http://Alma/XASDM/CalDeviceTable http://almaobservatory.org/XML/XASDM/4/CalDeviceTable.xsd\" schemaVersion=\"4\" schemaRevision=\"-1\">\n");
	...
	string CalDeviceTable::MIMEXMLPart(const asdm::ByteOrder* byteOrder) {
		...
		oss << "\n";
		oss << "<CalDeviceTable xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:cldvc=\"http://Alma/XASDM/CalDeviceTable\" xsi:schemaLocation=\"http://Alma/XASDM/CalDeviceTable http://almaobservatory.org/XML/XASDM/4/CalDeviceTable.xsd\" schemaVersion=\"4\" schemaRevision=\"-1\">\n";
   ...
   //
    ...
    if (file_exists(uniqSlashes(directory + "/CalDevice.xml")))
      setFromXMLFile(directory);
    else if (file_exists(uniqSlashes(directory + "/CalDevice.bin")))
      setFromMIMEFile(directory);
#endif
    else
