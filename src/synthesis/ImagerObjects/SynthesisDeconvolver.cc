	...
	if(decpars.algorithm==String("hogbom"))
      ...
      if (decpars.nTaylorTerms > 1) // wide-band
        itsDeconvolver.reset(new SDAlgorithmMTAspClean(decpars.nTaylorTerms, decpars.fusedThreshold, isSingle, decpars.largestscale));
	      ...
	      itsDeconvolver.reset(new SDAlgorithmAAspClean(decpars.scales, decpars.hogbomGain, decpars.fusedThreshold, isSingle, decpars.largestscale, -1, decpars.mfasp, decpars.lbfgsEpsF, decpars.lbfgsEpsX, decpars.lbfgsEpsG, decpars.lbfgsMaxit));
	  }
	  ...
	  itsDeconvolver.reset(new SDAlgorithmSpectralAspClean(decpars.scales, decpars.hogbomGain, decpars.waveletScales, decpars.waveletAmps, decpars.fusedThreshold, isSingle, decpars.largestscale, -1, decpars.waveletTrigger, decpars.mfasp, decpars.lbfgsEpsF, decpars.lbfgsEpsX, decpars.lbfgsEpsG, decpars.lbfgsMaxit));
	  }
  /*else if (decpars.algorithm==String("asp")) 
    {
      bool isSingle = false;
