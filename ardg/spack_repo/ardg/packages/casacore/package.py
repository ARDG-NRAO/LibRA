...
class Casacore(CMakePackage):
    ...
    version(
        "3.6.0",
        sha256="c88075aa73c2139b323b71a7f5d56cec5a6a0de649efd11e2d00ca033be5a0d7",
    )
    version(
        "3.5.0",
    ...
    version(
        "3.2.1",
        sha256="f87ce81d2b42ec5401cff8317baeeb9a3b408b716bb791ef252ad97af6e235ad",
    )
    version(
        "3.2.0",
    ...
    variant(
        "dysco", default=True, when="@3.5.0:", description="Build Dysco storage manager"
    )
        ...
        if spec.satisfies("~python"):
            args.extend(
                [
                    ...
                    self.define("BUILD_PYTHON3", False),
                ]
            )
        elif spec.satisfies("^python@3.0.0:"):
            args.extend(
                [self.define("BUILD_PYTHON", False), self.define("BUILD_PYTHON3", True)]
            )
        else:
            args.extend(
                [self.define("BUILD_PYTHON", True), self.define("BUILD_PYTHON3", False)]
            )
