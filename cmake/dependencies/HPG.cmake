...
set(LIBRA_HPG_FFTW_ARGS
  -DFFTW_LIBRARIES=${INSTALL_DIR}/lib/
  -DFFTW_ROOT=${INSTALL_DIR})

if(APPLE AND CMAKE_CXX_COMPILER_ID MATCHES "Clang")
  list(APPEND LIBRA_HPG_FFTW_ARGS
    -DFFTW_DOUBLE_OPENMP_LIB=${INSTALL_DIR}/lib/libfftw3_threads.dylib
    -DFFTW_FLOAT_OPENMP_LIB=${INSTALL_DIR}/lib/libfftw3f_threads.dylib)
endif()
...
ExternalProject_Add(
  ...
  PATCH_COMMAND  ${CMAKE_COMMAND} -E copy_if_different
                 ${CMAKE_SOURCE_DIR}/cmake/dependencies/patches/HPGDependenciesCMakeLists.txt
                 <SOURCE_DIR>/dependencies/CMakeLists.txt
  CONFIGURE_COMMAND PKG_CONFIG_PATH=${INSTALL_DIR}/lib/pkgconfig:$ENV{PKG_CONFIG_PATH} CMAKE_PREFIX_PATH=${INSTALL_DIR}:${CMAKE_PREFIX_PATH}:${INSTALL_DIR}/lib/cmake/Kokkos
                    ...
                    ${LIBRA_HPG_FFTW_ARGS}
                    -DHpg_ENABLE_MIXED_PRECISION=OFF -DHpg_ENABLE_EXPERIMENTAL_IMPLEMENTATIONS=OFF -DHpg_API=17
